...
echo_and_run cd "/home/ubuntu/catkin_ws/src/bveetamini/ros_arduino_python"
...
echo_and_run /usr/bin/env \
    ...
    "/bin/python3" \
    "/home/ubuntu/catkin_ws/src/bveetamini/ros_arduino_python/setup.py" \
     \
    build --build-base "/home/ubuntu/catkin_ws/build/bveetamini/ros_arduino_python" \
    install \
    --root="${DESTDIR-/}" \
